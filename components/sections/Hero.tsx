...
export default function Hero({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-brand-950 via-ink-950 to-ink-900 text-white">
      <div
        aria-hidden
      ...
      <div
        aria-hidden
        className="absolute -bottom-40 -left-40 h-[500px] w-[500px] rounded-full bg-brand-700/30 blur-3xl"
      />
      ...
      <div className="container relative pt-20 md:pt-28 pb-24 md:pb-32">
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <h1 className="mt-6 text-4xl md:text-6xl font-bold tracking-tight whitespace-pre-line text-balance leading-[1.1]">
            {t('title')}
          </h1>
          <p className="mt-6 text-base md:text-lg text-ink-200 leading-relaxed max-w-2xl">
            {t('subtitle')}
          </p>
